-- Migration 106: Sportello Digitale Personale
...
ALTER TABLE personnel_desk_requests ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS personnel_desk_requests_policy ON personnel_desk_requests;
CREATE POLICY personnel_desk_requests_policy ON personnel_desk_requests USING (true);
