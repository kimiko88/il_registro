...
func (h *Handler) RegisterRoutes(r *gin.RouterGroup) {
	...
	sched.GET("/slots/my", h.GetMySlots)
	sched.DELETE("/slots/:id", h.DeleteSlot)
	sched.GET("/bookings", h.GetTeacherBookings)

	// Parent
	sched.GET("/available-slots", h.GetAvailableSlots)
	sched.POST("/book", h.BookSlot)
	sched.GET("/my-bookings", h.GetParentBookings)
	sched.PATCH("/bookings/:id/cancel", h.CancelBooking)
}
