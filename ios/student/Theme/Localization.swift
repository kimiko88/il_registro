...
/// Public accessor for student string localization
public func studentLocalizedString(_ key: String, tableName: String? = nil, value: String = "", comment: String = "") -> String {
    ...
    // 3. Fallback to Italian (default localization of the school register)
...
func NSLocalizedString(_ key: String, comment: String) -> String {
    studentLocalizedString(key, comment: comment)
}
...
func NSLocalizedString(_ key: String, tableName: String? = nil, bundle: Bundle? = nil, value: String = "", comment: String) -> String {
    ...
    return studentLocalizedString(key, tableName: tableName, value: value, comment: comment)
}
