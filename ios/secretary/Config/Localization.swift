...
/// Public accessor for secretary string localization
public func secretaryLocalizedString(_ key: String, tableName: String? = nil, value: String = "", comment: String = "") -> String {
...
func NSLocalizedString(_ key: String, comment: String) -> String {
    secretaryLocalizedString(key, comment: comment)
}
...
func NSLocalizedString(_ key: String, tableName: String? = nil, bundle: Bundle? = nil, value: String = "", comment: String) -> String {
    ...
    return secretaryLocalizedString(key, tableName: tableName, value: value, comment: comment)
}
