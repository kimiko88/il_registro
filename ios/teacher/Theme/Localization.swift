...
/// Public accessor for teacher string localization
public func teacherLocalizedString(_ key: String, tableName: String? = nil, value: String = "", comment: String = "") -> String {
...
func NSLocalizedString(_ key: String, comment: String) -> String {
    teacherLocalizedString(key, comment: comment)
}
...
func NSLocalizedString(_ key: String, tableName: String? = nil, bundle: Bundle? = nil, value: String = "", comment: String) -> String {
    ...
    return teacherLocalizedString(key, tableName: tableName, value: value, comment: comment)
}
