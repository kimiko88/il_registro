        ...
        <div class="global-search-container">
          ...
          <div class="search-input-wrap row items-center q-px-md q-py-sm">
            ...
            <input
              ...
              placeholder="Cerca studenti, classi, circolari, voci di menu…"
              autocomplete="off"
              spellcheck="false"
          ...
          <div v-if="!query" class="search-hint q-pa-lg text-center text-grey-6">
            ...
            <span class="text-caption">Digita per cercare studenti, classi, genitori, circolari o voci di menu</span>
...
const menuItems = computed(() => {
  const base = {
    teacher: [
      ...
      { id: 'm-2', label: 'Presenze', icon: 'how_to_reg', color: 'teal', route: '/teacher/attendance', subtitle: 'Menu → Didattica' },
      { id: 'm-3', label: 'Agenda', icon: 'edit_calendar', color: 'orange', route: '/teacher/agenda', subtitle: 'Menu → Organizzazione' },
      { id: 'm-4', label: 'Scrutinio', icon: 'analytics', color: 'purple', route: '/teacher/scrutiny', subtitle: 'Menu → Didattica' },
      { id: 'm-5', label: 'Colloqui', icon: 'event', color: 'pink', route: '/teacher/colloqui', subtitle: 'Menu → Organizzazione' },
      { id: 'm-6', label: 'Sostituzioni', icon: 'swap_horiz', color: 'cyan', route: '/teacher/substitutions', subtitle: 'Menu → Organizzazione' },
    ],
    secretary: [
      { id: 'm-1', label: 'Studenti', icon: 'school', color: 'indigo', route: '/secretary/students', subtitle: 'Menu → Anagrafiche' },
      { id: 'm-2', label: 'Utenti', icon: 'people', color: 'teal', route: '/secretary/users', subtitle: 'Menu → Anagrafiche' },
      { id: 'm-3', label: 'Classi', icon: 'room', color: 'orange', route: '/secretary/classes', subtitle: 'Menu → Anagrafiche' },
      { id: 'm-4', label: 'Documenti', icon: 'description', color: 'purple', route: '/secretary/documents', subtitle: 'Menu → Atti' },
      { id: 'm-5', label: 'Comunicazioni', icon: 'email', color: 'pink', route: '/secretary/communications', subtitle: 'Menu → Servizi' },
    ],
    admin: [
      { id: 'm-1', label: 'Gestione Utenti', icon: 'people', color: 'indigo', route: '/admin/users', subtitle: 'Menu → Admin' },
      { id: 'm-2', label: 'Impostazioni', icon: 'settings', color: 'grey', route: '/admin/settings', subtitle: 'Menu → Admin' },
      { id: 'm-3', label: 'Analytics', icon: 'analytics', color: 'green', route: '/admin/analytics', subtitle: 'Menu → Admin' },
    ]
  }
...
const results = computed(() => {
  ...
  // Filter API results (students, classes, parents, communications)
...
const groupedResults = computed(() => {
  ...
  for (const item of results.value) {
    const g = item.group || (item.route?.startsWith('/teacher') ? 'Voce di Menu' : item.group || 'Risultati')
