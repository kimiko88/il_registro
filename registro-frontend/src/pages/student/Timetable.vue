  ...
  <q-page class="q-pa-md bg-grey-1">
    ...
    <div class="row items-center justify-between q-mb-md">
      <div>
        ...
        <div class="text-caption text-grey">Orario settimanale delle lezioni per la tua classe</div>
      </div>
    </div>
    ...
    <div v-else>
      <q-card v-if="scheduleEntries.length === 0" class="text-center q-pa-xl text-grey-6 shadow-1">
        ...
        <div class="text-caption">La segreteria non ha ancora configurato l'orario scolastico per la tua classe.</div>
      </q-card>
