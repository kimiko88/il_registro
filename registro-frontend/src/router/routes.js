...
export default [
    {
        ...
        children: [
            ...
            { path: 'secretary/timetable', component: () => import('@/pages/secretary/Timetable.vue'), meta: { title: 'Orario Scolastico & Cattedre', titleKey: 'routeTitles.timetable', roles: ['secretary', 'admin', 'superadmin', 'principal', 'vice_principal', 'collaboratore_ds'] } },
            ...
            { path: 'secretary/certificates', component: () => import('@/pages/secretary/Certificates.vue'), meta: { title: 'Certificati & Attestati', titleKey: 'routeTitles.certificates', roles: ['secretary', 'admin', 'superadmin', 'principal', 'vice_principal', 'assistente_amministrativo'] } },
            ...
            { path: 'secretary/verbali', component: () => import('@/pages/secretary/VerbaliManagement.vue'), meta: { title: 'Verbali & Modelli Riunioni', titleKey: 'routeTitles.verbali', roles: ['secretary', 'principal', 'vice_principal', 'admin', 'superadmin'] } },
            ...
            { path: 'ata/visitor-registry', component: () => import('@/pages/ata/VisitorRegistry.vue'), meta: { title: 'Registro Visitatori', titleKey: 'routeTitles.visitorRegistry', roles: ['collaboratore_scolastico', 'collaboratore_ds', 'principal', 'vice_principal', 'secretary', 'admin', 'superadmin'] } },
