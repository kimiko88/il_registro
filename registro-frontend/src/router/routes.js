...
export default [
    {
        ...
        children: [
            ...
            { path: 'secretary/pcto', component: () => import('@/pages/secretary/PCTO.vue'), meta: { title: 'Gestione PCTO', titleKey: 'routeTitles.pcto', roles: ['secretary', 'admin', 'superadmin', 'principal', 'vice_principal'] } },
            { path: 'secretary/textbooks', component: () => import('@/pages/secretary/Textbooks.vue'), meta: { title: 'Adozione Libri di Testo', titleKey: 'routeTitles.textbooks', roles: ['secretary', 'admin', 'superadmin', 'principal', 'vice_principal'] } },
            ...
            { path: 'secretary/sidi', component: () => import('@/pages/secretary/SidiExports.vue'), meta: { title: 'Flussi SIDI (MIM)', titleKey: 'routeTitles.sidiExports', roles: ['secretary', 'admin', 'superadmin', 'principal', 'vice_principal', 'dsga', 'assistente_amministrativo', 'assistente_alunni', 'assistente_contabilita'] } },
