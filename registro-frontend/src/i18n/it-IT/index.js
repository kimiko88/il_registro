export default {
  ...
  help: {
    ...
    teacher: {
      ...
      q1: 'Come registro le presenze della mia ora?',
      a1: 'Vai su "Le Mie Classi" → seleziona la classe → scheda "Presenze". Usa i pulsanti P (Presente), A (Assente), R (Ritardo) o U (Uscita) per ogni studente. Premi "Firma Lezione" per confermare e apporre la firma digitale.',
      q2: 'Come uso l\'inserimento voti rapido (Matrix View)?',
      a2: 'In "Voti" seleziona classe e materia, quindi attiva la vista a griglia Matrix. Puoi spostarti tra gli studenti con i tasti FRECCIA e TAB, inserire il voto numerico e premere INVIO senza aprire modali.',
      q3: 'Come creo un compito o una verifica in agenda?',
      a3: 'Vai su "Agenda" → clicca sul giorno desiderato → "Aggiungi evento". Scegli se si tratta di Compito, Verifica o Attività, imposta la materia e compila i dettagli. Gli studenti vedranno l\'evento nei loro compiti.',
      q4: 'Come invio una comunicazione urgente ai genitori?',
      a4: 'Vai su "Comunicazioni" → "Nuova Comunicazione". Seleziona la classe o i singoli studenti, spunta "Richiedi presa d\'atto" per obbligare alla lettura e invia. Riceverai conferma di chi ha letto il messaggio.',
      q5: 'Come imposto la disponibilità per i colloqui?',
      a5: 'Vai su "Colloqui" → "Imposta Disponibilità". Definisci i giorni della settimana, le fasce orarie e la durata degli slot (15, 20 o 30 minuti). I genitori potranno prenotare negli orari definiti.',
      q6: 'Come accedo alla gestione dello Scrutinio (solo Coordinatori)?',
      a6: 'Se sei coordinatore di classe, la voce "Scrutinio" compare nella barra laterale. Seleziona la classe, la sezione del quadrimestre e compila i voti proposti, giudizio sintetico e voto di condotta.',
      q7: 'Come si redige o consulta un PDP / PEI per alunni BES/DSA?',
      a7: 'Vai su "Piano Didattico Personalizzato (PDP)" dal menu classe. Puoi configurare le misure compensative (es. uso calcolatrice, formulari) e dispensative che verranno richiamate automaticamente nelle valutazioni.',
      q8: 'Come posso recuperare la bozza di un registro non salvato?',
      a8: 'Il sistema salva automaticamente le bozze delle lezioni ogni 15 secondi. In caso di chiusura accidentale della pagina, riaprendo il registro ti verrà chiesto se desideri ripristinare l\'ultima bozza.',
      q9: 'Come modifico la mia lingua di interfaccia e il tema scuro?',
      a9: 'Vai in "Impostazioni" nel tuo menu profilato. Puoi scegliere tra 9 lingue (Italiano, Inglese, Tedesco, Francese, Spagnolo, Russo, Ucraino, Arabo, Cinese) e attivare la Dark Mode o il font per dislessia.',
      q10: 'Come posso annullare una presenza o un voto errato inserito da poco?',
      a10: 'Dopo ogni inserimento compare un toast in basso con il pulsante "Annulla" attivo per 15 secondi. Se il tempo è trascorso, puoi modificare la cella nella griglia voti o presenze.'
    },
    student: {
      ...
      a1: 'Vai su "I Miei Voti" dal menu laterale. Troverai la tabella con tutti i voti scritti, orali e pratici, la media ponderata per materia e la media generale calcolata in tempo reale.',
      q2: 'Come funziona il Simulatore della Media?',
      a2: 'Nella sezione "I Miei Voti" clicca sul pulsante "Simulatore Media". Inserisci il voto ipotetico che pensi di prendere nella prossima verifica per vedere come cambierà la tua media di materia.',
      q3: 'Come controllo il contatore delle mie assenze e ritardi?',
      a3: 'Vai su "Le Mie Presenze". In alto trovi il contatore totale delle ore di assenza e la percentuale sul monte ore annuo. Sotto trovi il calendario mensile dettagliato.',
      q4: 'Dove posso trovare i compiti assegnati per i prossimi giorni?',
      a4: 'Nella sezione "Compiti" o nel widget "Timeline del Giorno" della tua Dashboard. I compiti sono ordinati per data di consegna con indicazione del docente e allegati scaricabili.',
      q5: 'Come posso scaricare la mia pagella provvisoria o finale?',
      a5: 'Vai su "Pagella & Documenti", seleziona il periodo scolastico (1° Quadrimestre o Finale) e clicca su "Scarica PDF Pagella". Il documento verrà scaricato sul tuo dispositivo.',
      q6: 'Come si visualizzano le ore di PCTO accumulate?',
      a6: 'Se frequenti il triennio, accedi alla sezione "PCTO & Portfolio". Vedrai il contatore delle ore svolte presso strutture convenzionate, i progetti completati e la scheda di valutazione del tutor.',
      q7: 'Come rispondo a un sondaggio o una circolare della scuola?',
      a7: 'Accedi a "Comunicazioni", seleziona la circolare. Se è richiesta la risposta o presa d\'atto, apparirà il pulsante "Conferma Lettura" o i campi del sondaggio da compilare.',
      q8: 'Come posso attivare l\'accessibilità per dislessia (OpenDyslexic)?',
      a8: 'In qualsiasi pagina premi sulla barra di accessibilità o vai in "Profilo" → "Impostazioni accessibilità". Puoi attivare il carattere OpenDyslexic e l\'alto contrasto.',
    ...
    parent: {
      ...
      a1: 'Nel menu in alto o nella dashboard compare il selettore "Seleziona Figlio". Clicca sul nome o sulla foto del figlio di cui vuoi consultare il registro.',
      ...
      a3: 'Vai su "Colloqui" → seleziona il docente interessato → scegli una data con slot disponibili evidenziati in verde → clicca "Prenota". Riceverai la conferma email.',
      q4: 'Come effettuo i pagamenti scolastici con PagoPA?',
      a4: 'Vai su "Pagamenti PagoPA". Vedrai l\'elenco degli avvisi di pagamento (rette, gite, contributi). Clicca "Paga con PagoPA" per pagare online o scaricare il bollettino QR.',
      q5: 'Come posso giustificare un\'assenza o un ritardo online?',
      a5: 'Vai su "Presenze & Giustificazioni" → individua l\'assenza segnalata con il badge rosso → clicca "Giustifica" → seleziona la causale (es. Motivi di salute) e firma digitalmente.',
      q6: 'Come scarico la pagella di mio figlio in formato PDF?',
      a6: 'Seleziona il figlio → vai su "Pagella" → seleziona il periodo (1° Quadrimestre o Finale) → clicca "Scarica Pagella PDF".',
      q7: 'Dove trovo le circolari con obbligo di presa d\'atto?',
      a7: 'Nella sezione "Comunicazioni". Le circolari che richiedono la tua firma o presa d\'atto presentano una modale evidenziata: clicca "Prendo d\'Atto" per registrare la risposta.',
      q8: 'Come posso richiedere il supporto della segreteria?',
      a8: 'Vai in "Supporto & FAQ" o seleziona "Contatta Assistenza" per inviare un ticket direttamente alla segreteria della scuola.',
      q9: 'Posso delegare un altro genitore o tutore alla visione delle note?',
      a9: 'La segreteria può associare più account tutori allo stesso studente. Ciascun tutore possiede credenziali personali e riceve le relative notifiche.',
    ...
    secretary: {
      ...
      a1: 'Dalla dashboard o dalla sezione "Studenti" usa la barra di ricerca universale inserendo nome, cognome, codice fiscale o classe per accedere alla scheda anagrafica.',
      q2: 'Come posso generare e stampare un certificato di iscrizione o frequenza?',
      a2: 'Vai su "Certificati & Documenti" → seleziona lo studente → scegli la tipologia di certificato richiesta → clicca "Genera PDF". Il documento include il timbro digitale e la firma.',
      q3: 'Come si gestiscono le sostituzioni dei docenti assenti?',
      a3: 'Vai su "Orario & Sostituzioni" → seleziona la giornata → inserisci il docente assente. Il sistema suggerisce i docenti a disposizione o con ore buche per l\'assegnazione.',
      q4: 'Come si esportano i flussi dati per il Ministero (MIF / Anagrafe Nazionale)?',
      a4: 'Vai su "Report & Statistiche" → seleziona "Export Ministero" → configura il periodo e il formato di esportazione richiesto dal portale SIDI.',
      q5: 'Come posso creare le credenziali per un nuovo iscritto?',
      a5: 'Vai su "Gestione Utenti" → "Nuovo Utente" → inserisci i dati anagrafici e il ruolo (studente o genitore). Verrà inviata un\'email automatica con le credenziali di primo accesso.',
      q6: 'Come si configurano gli elenchi delle classi e le sezioni per il nuovo anno?',
      a6: 'In "Gestione Classi" puoi creare le nuove sezioni, importare gli studenti promossi dall\'anno precedente ed effettuare l\'assegnazione dei docenti alle discipline.',
      q7: 'Come pubblico una circolare per tutti i docenti o i genitori?',
      a7: 'Vai su "Comunicazioni & Bacheca" → "Nuova Circolare" → seleziona i ruoli o le classi destinatarie → imposta l\'obbligo di presa d\'atto e clicca "Pubblica".',
      q8: 'Come si gestiscono i libri di testo adottati per classe?',
      a8: 'Nella sezione "Libri di Testo" seleziona la classe e la disciplina → inserisci il codice ISBN, il titolo, l\'editore e il prezzo del volume approvato.',
      q9: 'Come consulto l\'elenco degli avvisi PagoPA pendenti?',
      a9: 'Accedi al modulo "Amministrazione & PagoPA" per verificare lo stato degli incassi, scaricare i rendiconti giornalieri e sollecitare i pagamenti scaduti.',
      q10: 'Cosa devo fare per annullare un documento protocollo rilasciato erroneamente?',
      a10: 'Nella scheda "Archivio Documentale" individua il protocollo → clicca "Annulla con motivazione". L\'operazione viene registrata nell\'audit log di sistema.'
    },
    admin: {
      ...
      a1: 'Nella dashboard "Monitoraggio Sistema" trovi i grafici in tempo reale di utilizzo CPU, memoria RAM, connessioni PostgreSQL attive e latency delle API.',
      q2: 'Come si aggiunge una nuova scuola o un plesso scolastico?',
      a2: 'Vai su "Gestione Scuole" → "Aggiungi Istituto". Inserisci il Codice Meccanografico, il nome della scuola, l\'indirizzo e l\'email PEC istituzionale.',
      q3: 'Come posso forzare il reset della password o attivare il 2FA per uno staff?',
      a3: 'In "Gestione Utenti" individua l\'account → clicca "Sicurezza" → seleziona "Forza Reset Password" o "Abilita Obbligo Autenticazione a Due Fattori (2FA)".',
      q4: 'Come consulto il Registro di Audit Log immutabile?',
      a4: 'Vai su "Audit Log & Tracciabilità". Puoi filtrare le operazioni per utente, tipo di evento (login, modifica voti, export), data e indirizzo IP sorgente.',
      q5: 'Come gestisco le Feature Flags per abilitare nuove funzioni?',
      a5: 'Nella sezione "Feature Flags & Moduli" puoi attivare o disattivare moduli specifici (es. PagoPA, Google Classroom SSO, Matrix View) per singolo istituto.',
      q6: 'Come si analizzano i dati sulla dispersione scolastica e assenteismo?',
      a6: 'Accedi al pannello "Analytics & BI". Il sistema calcola automaticamente gli indicatori di rischio assenze (>25% del monte ore) e la media voti inferiore al 6.0.',
      q7: 'Come si configurano le integrazioni SSO con Google Workspace e Microsoft 365?',
      a7: 'Vai su "Integrazioni & SSO" → inserisci il Client ID e la Secret Key forniti dalla console Google Cloud o Azure AD per abilitare l\'accesso Single Sign-On.',
      q8: 'Come si esegue il backup e il ripristino del database?',
      a8: 'In "Database & Backup" puoi lanciare un dump istantaneo PostgreSQL o pianificare backup automatici su storage remoto cifrato S3.',
      q9: 'Come posso visualizzare la matrice completa dei ruoli e permessi (RBAC)?',
      a9: 'Vai su "Ruoli & Permessi". Troverai la matrice interattiva per verificare quali risorse sono accessibili da ciascuno dei 9 ruoli di sistema.',
      q10: 'Come posso mettere la piattaforma in modalità manutenzione programmata?',
      a10: 'In "Impostazioni Sistema" attiva il toggle "Modalità Manutenzione". Gli utenti non-admin vedranno un banner informativo e non potranno inserire nuovi dati.'
    }
  },
  onboardingExtra: {
