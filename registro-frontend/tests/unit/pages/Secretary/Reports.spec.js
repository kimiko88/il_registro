...
describe('Reports', () => {
    ...
    it('opens report dialog for topics and notes', () => {
        wrapper.vm.openReport('topics')
        expect(wrapper.vm.currentReport).toBe('topics')
        expect(wrapper.vm.showDialog).toBe(true)

        wrapper.vm.openReport('notes')
        expect(wrapper.vm.currentReport).toBe('notes')
        expect(wrapper.vm.showDialog).toBe(true)
    })
