...
@Composable
fun StudentBadgesScreen(
    badges: List<StudentBadgeItem> = emptyList(),
    onBack: () -> Unit = {}
) {
    Scaffold(
        topBar = {
                        ...
                        Column(modifier = Modifier.padding(14.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
                            Row(
                                ...
                                Surface(color = Color(0xFFF59E0B), shape = RoundedCornerShape(6.dp)) {
                                    Text(badge.level, color = Color.White, modifier = Modifier.padding(horizontal = 6.dp, vertical = 2.dp), fontSize = 10.sp)
                                }
                            }
                            Text(badge.competence, fontSize = 12.sp, color = MaterialTheme.colorScheme.primary, fontWeight = FontWeight.SemiBold)
                            Text(badge.verificationCode, fontSize = 12.sp, color = Color.Gray)
                        }
                    }
                }
            }
